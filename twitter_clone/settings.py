...
SECRET_KEY = 'django-insecure-dmc@mpkhfa0e0w9!o=!^95tk-xqq+(dmj+yqyb8z-75np4xo4a'
...
# URL that handles the media served from MEDIA_ROOT. Public URL of MEDIA_ROOT
MEDIA_URL = '/media/'

# Serve static files that aren't tied to a particular app
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
