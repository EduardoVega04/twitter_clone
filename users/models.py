...
class HomeFeed(models.Model):
    ...
    following_tweets = models.ManyToManyField(Post, blank=True, related_name='home_feeds_tweet')
    following_retweets = models.ManyToManyField(Post, blank=True, related_name='home_feeds_retweet')
    following_likes = models.ManyToManyField(Post, blank=True, related_name='home_feeds_like')
...
class ProfileFeed(models.Model):
    ...
    retweeted = models.ManyToManyField(Post, blank=True, related_name='profile_feeds_retweet')
    liked = models.ManyToManyField(Post, blank=True, related_name='profile_feeds_like')
